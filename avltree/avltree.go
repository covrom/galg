...
// Some of default comparators
var (
	IntComparator    Comparator[int]    = BasicComparator[int]
	UintComparator   Comparator[uint]   = BasicComparator[uint]
	StringComparator Comparator[string] = BasicComparator[string]
)

func BasicComparator[T constraints.Ordered](a, b T) int8 {
	switch {
	case a > b:
		return 1
	case a < b:
...
// New instantiates an AVL tree with the Comparator, i.e. keys are of type int.
